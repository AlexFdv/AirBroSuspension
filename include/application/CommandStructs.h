...
typedef enum
{
    ...
    CMD_GET_COMPRESSOR_PRESSURE = ENV_COMMAND_TYPE | 0b0011,
    CMD_SET_COMPRESSOR_MAX_PRESSURE = ENV_COMMAND_TYPE | 0b0100,
    CMD_SET_COMPRESSOR_MIN_PRESSURE = ENV_COMMAND_TYPE | 0b0101,
    CMD_GET_COMPRESSOR_MAX_PRESSURE = ENV_COMMAND_TYPE | 0b0110,
    CMD_GET_COMPRESSOR_MIN_PRESSURE = ENV_COMMAND_TYPE | 0b0111
} COMMAND_TYPE;
